        ...
        <% ProductoController productoController = new ProductoController();
            ...
            <body>
                <main>
                    <div id="loader">
                        <div class="TruckLoader">
                            ...
                            <div class="infoObjeto">
                                <% try {
                                    Producto producto = new Producto(identificador, "a", 1, "Normal");
                                    productoController.eliminar(producto);
                                } catch (Exception ex) {%>
                                    mensaje = "Ha ocurrido un error eliminando el producto";
                                    <%}%>
                                        <h3>
                                            <%=mensaje%>
                                        </h3>
                    ...
                    <div class="botones">
                        <a href="./leer-input.jsp?tabla=producto&accion=eliminar">
                            <div class="boton">
                                Realizar otra eliminación
                            </div>
                        </a>
